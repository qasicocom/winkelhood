...
/**
 * Registered macro ChangeLanguage
 *
 * usage: Html::ChangeLanguage ();
 * --------------------------------------------------------------------
 */
HTML::macro( 'ChangeLanguage', 
	function ( $short = FALSE, $class = "" ) {
...
/**
 * Registered macro ActionButton
 *
 * usage: Html::ActionButton ();
 * --------------------------------------------------------------------
 */
HTML::macro( 'ActionButton', 
	function ( $button_class = "btn-mini btn-success", $link = array() ){
...
/**
 * Registered macro DatatableTools
 *
 * usage: Html::DatatableTools ();
 * --------------------------------------------------------------------
 */
...
/**
 * Registered macro tableAction
 *
 * usage: Html::tableAction ();
 * --------------------------------------------------------------------
 */
