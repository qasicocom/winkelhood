<?php
namespace Winkelhood\Costumer\Models;
use \Eloquent;

/**
 * Model 'retail_costumer' tables
 *
...
class Costumer extends Eloquent
{
	 ...
	 * --------------------------------------------------------------------
	 */
	protected $table = 'retail_costumer';
	// --------------------------------------------------------------------
	 ...
	 * --------------------------------------------------------------------
	 */
	protected $fillable = [ 'company_id','name','email','address','kec_id','phone' ];
	// --------------------------------------------------------------------
