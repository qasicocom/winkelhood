	...
	<div class="row">
		<div class="col-sm-6">
			...
			<div class="form-group field-name">
				...
				{{ Form::text  ( 'name', $costumer->name, array( 'class'=>'form-control', 'required' ) ) }}
			</div>
			<div class="form-group field-email">
				{{ Form::label ( 'email', trans( 'form.label.email' ), array('class' => 'control-label')) }}
				{{ Form::text  ( 'email', $costumer->email, array( 'class'=>'form-control' ) ) }}
			</div>
			<div class="form-group field-address">
				{{ Form::label ( 'address', trans( 'form.label.alamat' ), array('class' => 'control-label')) }}
				<textarea name="address" rows="" cols="" spellcheck="false" class="form-control noresize">{{ $costumer->address }}</textarea>
			</div>
			<div class="form-group field-phone">
				{{ Form::label ( 'phone', trans( 'form.label.phone' ), array('class' => 'control-label')) }}
				{{ Form::text  ( 'phone', $costumer->phone, array( 'class'=>'form-control' ) ) }}
			</div>
